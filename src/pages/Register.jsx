...
export default function Register() {
    ...
    useEffect(() => {
        ...
        setIsActive(username && email && password && password === confirmPassword);
    }, [formData]);
    ...
    const handleResponse = (data) => {
        ...
        if (data.message === "Registered Successfully") {
            ...
            const errorMessages = {
                ...
                "Mobile number invalid": "Invalid mobile number.",
                "Password must be at least 8 characters": "Password must be at least 8 characters long.",
                "default": "Please try again later or contact us for assistance."
            };
